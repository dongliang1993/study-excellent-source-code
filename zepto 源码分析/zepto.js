...
(function(global, factory) {
  ...
  var Zepto = (function() {
      ...
      var undefined, key, $, classList, emptyArray = [],
          ...
          // 判断 isArray 为什么没有用 Object.prototype.toString.call([1,3]) 呢？        
      ...
      // 用来获取对象的类型。支持的类型有: null undefined boolean number string function array date regexp object error.
      // 对于其他的类型，直接返回 “object”
      // 如果想知道是否是纯对象，需要使用 isPlainObject 函数
      function type(obj) {
        // 1. null == null 并且 null == undefined
        // 2. Object.prototype.toString(undefined) 和 Object.prototype.toString(null)
        // 都返回 [object Object]
        // 这两种类型的直接用 String 函数返回他们的字符串形式
        // class2type 一开始是一个空对象，后面被加工了一次，最终变成如下：
        // {
        //   [object Array]: "array"
